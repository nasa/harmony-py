...
* **[ICESat-2 Cloud Cookbook](https://nasa-openscapes.github.io/earthdata-cloud-cookbook/tutorials/IS2_Harmony.html)** - Tutorial on working with ICESat-2 elevation data in the cloud with harmony-py
